# tf-aws-pes-docker-compose
Terraform Enterprise FDO PES Docker Compose

This Terraform Code is dedicated to install Terraform Enterprise FDO external services on the Amazon AWS using Docker compose
